...
def odoo_search(model_name: str, domain: str = "[]", fields: str = "[]", limit: int = 10) -> str:
    """Wyszukaj rekordy w Odoo. Zwraca JSON jako string."""
    import json
    res = search_odoo_records(model_name=model_name, domain=domain, fields=fields, limit=limit)
...
def odoo_create(model_name: str, values_json: str, reason: str) -> str:
    ...
    return create_odoo_record(model_name=model_name, values_json=values_json, reason=reason)
