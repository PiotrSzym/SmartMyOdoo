...
class TestSmartMyVault(unittest.TestCase):
    def setUp(self):
        ...
        self.files_to_cleanup = [
            vault.PIN_SALT_FILE,
            vault.MASTER_SALT_FILE,
            vault.PIN_KEY_FILE,
            vault.MASTER_KEY_FILE,
            vault.VAULT_DATA_FILE,
        ]
    ...
    def test_master_password_decryption(self, mock_getpass):
        ...
        self.assertEqual(
            vk_master, vk_pin
        )  # Dowodzi że asymetria ról działa dla Key Encrypting Key!
    ...
    def test_run_command_flattener(self, mock_getpass, mock_run, mock_exit):
        ...
        self.assertEqual(
            env_passed["RUN_SECRET"], "secret_for_run"
