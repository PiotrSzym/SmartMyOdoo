...
def propose_magic_fix(
    ...
    proposal = create_proposal(
        ...
        values={
            "system_warning": "🚨 UWAGA: Ta akcja narusza standardowe zasady Odoo. Zostanie wykonana przez surowe zapytania SQL lub nadpisanie kontekstu."
        },
        reason=reason,
