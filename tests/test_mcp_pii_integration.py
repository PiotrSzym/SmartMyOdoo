...
from smartmyodoo.mcp.server import search_odoo_records, create_odoo_record, get_pii_middleware
...
def test_mcp_pii_integration_roundtrip(mock_create_proposal, mock_get_client):
    ...
    response = create_odoo_record("res.partner", values_json, reason, workspace_id="testws")
